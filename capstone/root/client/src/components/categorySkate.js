        ...
        return (
           ...
           <div className=''>
            ...
            <br>
                ...
                <div style={{ padding:'6rem', margin: '0 auto', maxWidth: 1000, marginLeft: 300 }}>

            <h2 className='underline' style={{ fontSize: 50 }}>Looking for some thrills?</h2>

                </div>


        <div style={{ marginTop: 35, maxWidth: '100%', marginBottom: 80 }}>
